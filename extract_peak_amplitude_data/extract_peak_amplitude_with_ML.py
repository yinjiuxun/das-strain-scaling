...
def extract_peak_amplitude(event_folder, peak_amplitude_dir, ii_region, data_path, pick_path, catalog, das_info, P_window_list, S_window_list, snr_window, i_eq):
    ...
    gca.scatter(channel_S, pick_S + peak_S_time, s=3, c=snrS, cmap='jet')
    cbar = gca.scatter(channel_P, pick_P + peak_P_time, s=3, c=snrP, cmap='jet')
...
region_list = ['ridgecrest', 'mammothS', 'mammothN', 'Sanriku', 'LA-Google', 'arcata']
