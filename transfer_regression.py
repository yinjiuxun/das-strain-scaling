...
site_term_P = fit_regression_transfer(peak_amplitude_df, regP_pre, wavetype='P', weighted=weighted, M_threshold=M_threshold, snr_threshold=snr_threshold, min_channel=snr_threshold)
site_term_S = fit_regression_transfer(peak_amplitude_df, regS_pre, wavetype='S', weighted=weighted, M_threshold=M_threshold, snr_threshold=snr_threshold, min_channel=snr_threshold)
