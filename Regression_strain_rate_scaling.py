...
#%% Regression with attenuation (Doesn't work!)
# nearby_channel_number_list = [100]#[10, 20, 50, 100, -1]

# regression_results_dir = results_output_dir + '/regression_results_smf_attenuation'
# if not os.path.exists(regression_results_dir):
#     os.mkdir(regression_results_dir)
...
#     mag_slopeP.append(regP.params[-2])
#     mag_slopeP.append(regP.params[-3])
#     dist_slopeP.append(regP.params[-1])
#     mag_slopeS.append(regS.params[-2])
#     mag_slopeS.append(regS.params[-3])
#     dist_slopeS.append(regS.params[-1])
