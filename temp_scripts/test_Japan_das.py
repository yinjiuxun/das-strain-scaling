...
sanriku_conversion_factor = np.pi/32768*1550*1e-9/(4*np.pi*1.468*40*0.78) * 1e6

# load the event data
with h5py.File(event_data_file, 'r') as f:
        event_data = f['DAS'][:]
event_data = event_data.T * sanriku_conversion_factor
...
# %% plot a figure for data visualization
pclip=90
